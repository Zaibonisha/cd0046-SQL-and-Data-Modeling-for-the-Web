...
Revision ID: 71abf779a2ce
Revises: 
Create Date: 2024-04-05 13:19:29.283157
...
def downgrade():
    ...
    sa.Column('num_upcoming_shows', sa.INTEGER(), autoincrement=False, nullable=False),
